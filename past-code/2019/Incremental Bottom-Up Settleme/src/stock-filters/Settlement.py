...
inputs = [
			(
				...
				("Submitted for the 2019 GDMC competition.", "label"),
				("On 256x256 maps, apply selection box across entire terrain space (altitude/depth doesn't matter) and run with default settings. Generation may take a while. Check console for progress.", "label"),
